...
import com.aslua.CharSeqReader;

import static  com.aslua.language.lua.LuaType.*;
...
public class LuaLexer {
	...
	private static int zzUnpackAction(int offset, int [] result) {
		...
		int l = LuaLexer.ZZ_ACTION_PACKED_0.length();
		while (i < l) {
			int count = LuaLexer.ZZ_ACTION_PACKED_0.charAt(i++);
			int value = LuaLexer.ZZ_ACTION_PACKED_0.charAt(i++);
	...
	private static int zzUnpackRowMap(int offset, int [] result) {
		int i = 0;  /* index in packed string  */
		int j = offset;  /* index in unpacked array */
		int l = LuaLexer.ZZ_ROWMAP_PACKED_0.length();
		while (i < l) {
			int high = LuaLexer.ZZ_ROWMAP_PACKED_0.charAt(i++) << 16;
			result[j++] = high | LuaLexer.ZZ_ROWMAP_PACKED_0.charAt(i++);
		}
		return j;
	}
	...
	private static int zzUnpackTrans(int offset, int [] result) {
		int i = 0;       /* index in packed string  */
		int j = offset;  /* index in unpacked array */
		int l = LuaLexer.ZZ_TRANS_PACKED_0.length();
		while (i < l) {
			int count = LuaLexer.ZZ_TRANS_PACKED_0.charAt(i++);
			int value = LuaLexer.ZZ_TRANS_PACKED_0.charAt(i++);
			value--;
			do result[j++] = value; while (--count > 0);
		}
		return j;
	...
	private static int zzUnpackAttribute(int offset, int [] result) {
		int i = 0;       /* index in packed string  */
		int j = offset;  /* index in unpacked array */
		int l = LuaLexer.ZZ_ATTRIBUTE_PACKED_0.length();
		while (i < l) {
			int count = LuaLexer.ZZ_ATTRIBUTE_PACKED_0.charAt(i++);
			int value = LuaLexer.ZZ_ATTRIBUTE_PACKED_0.charAt(i++);
			do result[j++] = value; while (--count > 0);
		}
		return j;
	}
	...
	private static char [] zzUnpackCMap() {
		...
		while (i < 2884) {
			int  count = LuaLexer.ZZ_CMAP_PACKED.charAt(i++);
			char value = LuaLexer.ZZ_CMAP_PACKED.charAt(i++);
		...
		while (true) {
			...
			if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
				...
				switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
					...
					case 82, 145, 146, 144, 143, 115, 116, 108, 84, 159, 83, 85: break;
					case 2:
